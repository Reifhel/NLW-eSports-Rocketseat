            ...
            <Dialog.Title className="text-3xl text-white font-black"> Publique um anúncio </Dialog.Title>
              ...
              <form onSubmit={handleCreatedAd} className="mt-8 flex flex-col gap-4">
                ...
                <div className="flex flex-col gap-2">
                  ...
                  <select defaultValue="" className="bg-zinc-900 py-3 px-4 rounded text-sm placeholder:text-zinc-500"
                  id="game" name="game">
                ...
                <div className="flex gap-6">
                  ...
                  <div className="flex flex-col gap-2">
                    <label htmlFor="weekDays">Quando costuma Jogar?</label>
                        ...
                        <ToggleGroup.Root type="multiple" className="grid grid-cols-4 gap-1" value={weekDays} onValueChange={setWeekDays}>
                            <ToggleGroup.Item
                                value="0"
                                title="Domingo"

    ...
    <div className="grid grid-cols-6 gap-6 mt-16">
      ...
      <a href="" className="relative rounded-lg overflow-hidden">
        ...
        <div className="w-full pt-16 pb-4 px-4 bg-game-gradiant absolute bottom-0 left-0 right-0">
          ...
          <span className="text-zinc-400 text-sm block mt-1"> 3 anúncios </span>
        </div>
      </a>
    ...
    <div className="pt-1 bg-nlw-gradiant self-stretch rounded-lg overflow-hidden mt-8">
      <div className="bg-[#2A2634] px-8 py-6 flex justify-between items-center">
        ...
        <div>
          ...
          <span className="text-zinc-400 text-1xl block">Publique um anúncio para encontrar novos players!</span>
        </div>
